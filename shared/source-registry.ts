...
export const CITATION_ALLOWLIST: SourceRegistryEntry[] = [
  ...
  { host: 'wsj.com', label: 'The Wall Street Journal', tier: 'B', regions: ['US', 'GLOBAL'], role: 'citation' },
  ...
  { host: 'hbx.com', label: 'HBX', tier: 'B', regions: ['GLOBAL'], role: 'citation', notes: 'Hypebeast retail journal; prefer reported history features over shop copy.' },
  { host: 'surfacemag.com', label: 'Surface', tier: 'B', regions: ['US', 'GLOBAL'], role: 'citation' },
  { host: 'designboom.com', label: 'designboom', tier: 'B', regions: ['GLOBAL'], role: 'citation' },
  ...
  { host: 'adage.com', label: 'Ad Age', tier: 'B', regions: ['US', 'GLOBAL'], role: 'citation', notes: 'Marketing / product launches; prefer reported features.' },
  ...
  { host: 'fastcompany.com', label: 'Fast Company', tier: 'B', regions: ['US', 'GLOBAL'], role: 'citation', notes: 'Design / culture features; prefer dedicated collab coverage over list dumps.' },
  ...
  { host: 'hypebae.com', label: 'Hypebae', tier: 'B', regions: ['GLOBAL'], role: 'citation' },
  {
    ...
    regions: ['US', 'GLOBAL'],
    role: 'citation',
    notes: 'Kicks On SI / footwear features OK — e.g. Billie Eilish By You.',
  },
  {
    host: 'vergemagazine.co.uk',
    label: 'Verge Magazine',
    tier: 'B',
    regions: ['UK'],
    role: 'citation',
    notes: 'UK lifestyle / fashion — dedicated collab features only.',
  },
  {
    host: 'highxtar.com',
    label: 'HIGHXTAR',
    ...
    regions: ['GLOBAL'],
    role: 'citation',
    notes: 'Fashion / sneakers — dedicated collab features only.',
  },

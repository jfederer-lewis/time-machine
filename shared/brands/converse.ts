import type { BrandConfig, BrandMoment } from '../brand'
import {
 ...
 *
 * Timeline source of truth for narrative beats:
 * https://www.converse.com/uk/en/landing-converse-history
 * (mirrored on other market history landings). Exact days/months added only when
 * independently corroborated; otherwise year or period-estimate.
 *
 ...
 *   (older secondary sources often say 1932 — superseded here by brand timeline).
...
export const converseBrand: BrandConfig = {
  ...
  timelineTitle: 'The story of Converse',
  heritageNote:
    'For 115+ years — from a Malden rubber shop to a silhouette worn everywhere. Moments from Converse’s own history, with calendar dates where they’re attested.',
  palette: {
    ink: '#141414',
    paper: '#F5F4F0',
    muted: '#5C5C5C',

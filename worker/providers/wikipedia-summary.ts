...
const WIKI_TITLE_ALIASES: Record<string, string> = {
  ...
  'tyler, the creator': 'Tyler, the Creator',
  'golf le fleur': 'Golf le Fleur',
  'golf le fleur*': 'Golf le Fleur',
  'golf le fleur* one star': 'Golf le Fleur',
  'le fleur': 'Golf le Fleur',
  'le fleur*': 'Golf le Fleur',
  '1908 program': 'Tyler, the Creator',
  'virgil abloh': 'Virgil Abloh',
  'converse x virgil abloh': 'Virgil Abloh',
  'abloh chuck 70': 'Virgil Abloh',
  'ghosting chuck': 'Virgil Abloh',
